...
const CardItem = () => {
  return (
    <div>
      ...
      <img data-testid="customer_products__img-card-bg-image-" src="https://via.placeholder.com/150" alt="placeholder" />
      <div>
        ...
        <div>
          ...
          <p data-testid="customer_products__input-card-quantity-"></p>
